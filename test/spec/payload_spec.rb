...
describe ExceptionReporter::Payload do
  let(:payload) { ExceptionReporter::Payload.new(exception['class'], exception['message'], backtrace, exception['time']) }
